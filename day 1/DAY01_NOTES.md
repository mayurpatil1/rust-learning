...
fn main() {
    ...
    hero.health -= 20; // works only because `hero` is `mut`
...
**Next up — Day 2:** Ownership & borrowing. Store rooms in a `HashMap<String, Room>` and move the player between them. The big one.
